  ...
  if (userData != null) {
    ...
    // 🔥 BƯỚC QUAN TRỌNG: LẤY FULL PROFILE
    final fullUser = await AuthApi.getUser(userId, token);
    ...
    if (fullUser != null) {
      ...
      await prefs.setString('userData', jsonEncode(fullData));

      print("FULL USER SAVED: $fullData");
      ...
      setState(() => _msg = "Không lấy được thông tin user!");
    }
  } else {
    setState(() => _msg =
  ...
  setState(() => _loading = false);
    ...
    Widget _input(TextEditingController c, String t, IconData i, bool e,
        {bool pw = false}) {
      return TextField(
        controller: c,
        obscureText: pw,
