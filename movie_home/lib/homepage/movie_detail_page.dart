...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  String? _videoKey; // ✅ lưu video key
          ...
          _buildSection(
            ...
            Text(
              ...
              style: const TextStyle(
                  height: 1.5, fontSize: 16.5, color: Colors.black87),
        ...
        Container(
          ...
          child: ClipRRect(
            ...
            child: Image.network(widget.movie.posterUrl,
                width: 130, height: 195, fit: BoxFit.cover),
          ),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Wrap(
                  spacing: 8,
                  children: ['2D', 'Phụ đề', 'T16'].map(_tag).toList()),
            ],
          ),
        ),
      ],
      ...
      children: [
        ...
        Container(
          ...
          decoration: _boxDecoration(
              color: content is Text ? Colors.white : Colors.black,
              radius: 16),
          child: ClipRRect(
  ...
  Widget _buildTrailerContent() {
    ...
    // ❌ nếu video lỗi → mở YouTube ngoài
    if (_ytController == null) {
      return GestureDetector(
        onTap: () {
          if (_videoKey != null) {
            openYoutube(_videoKey!);
          }
        },
        child: Container(
          height: 180,
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () => Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => BookingPage(movie: widget.movie))),
